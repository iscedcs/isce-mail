...
const ISCENewsLetterMail = ({ message, image }: ISCENewsLetterMailProps) => {
  const sanitizedHTML = parse(message);
  const year = new Date().getFullYear();
  const previewText = buildPreviewText(message, "ISCE Newsletter");
...
export default ISCENewsLetterMail;
