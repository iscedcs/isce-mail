...
interface PtCohortWelcomeMailProps {
  message: string;
  cohortName: string;
  startDate: string;
  mentorName: string;
          ...
          <Body className="w-full bg-[#f5f5f5]">
            <Container className="w-full max-w-[600px] mx-auto bg-white">
              ...
              <Section
                ...
                <Text
                  className="text-[15px] text-green-200 mt-1 mb-0"
              ...
              {communityLink && (
                <Section className="text-center pb-4">
                  <Button
                    href={communityLink}
                    className="cursor-pointer rounded-full text-white text-[13px] bg-[#25d366]"
...
export default PtCohortWelcomeMail;
