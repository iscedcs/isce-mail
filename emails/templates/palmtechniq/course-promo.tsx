          ...
          <Body className="w-full bg-[#f5f5f5]">
            <Container className="w-full max-w-[600px] mx-auto bg-white">
              ...
              <Section
                style={{
                  backgroundImage:
                    "url(https://isce-mail.vercel.app/static/PalmTechnIQ.png)",
              ...
              <Section
                ...
                <Button
                  href={link}
                  className="cursor-pointer rounded-full text-white text-[14px] font-semibold bg-green-600"
                  style={{ padding: "14px 40px", margin: "0 auto" }}>
                  Claim This Offer →
                </Button>
              </Section>
