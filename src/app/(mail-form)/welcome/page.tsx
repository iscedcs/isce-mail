...
export default function WelcomeForm() {
  ...
  const { restoreDraft, discardDraft } = useDraftAutosave("welcome-draft", form, setForm);
  useEffect(() => {
    restoreDraft();
  }, []);
  ...
  return (
    <form className="space-y-4 px-4 md:px-6 max-w-3xl mx-auto py-10">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold">Welcome - Send emails</h1>
          ...
          <Label className="flex gap-1.5 items-center" htmlFor="link">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className=" bg-white border  w-[60%] text-center mx-auto text-[13px] p-[10px] rounded-lg border-[#b5b5b5] ">
                  <p>
                    Enter the link that directs users what you are trying to
                    introduce them to.
                  </p>
                </TooltipContent>
              </Tooltip>
