...
export default function NewsLetterForm() {
  ...
  const [form, setForm] = useState<INewsLetterForm>({
    subject: "",
    basis: "ISCE",
    message: "",
    image: "",
  ...
  return (
    <form className="space-y-4 px-4 md:px-6 max-w-3xl mx-auto py-10">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold">NewsLetter - Send emails</h1>
          ...
          <Label
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                {/* <TooltipContent className=" bg-white border  w-[60%] text-center mx-auto text-[13px] p-[10px] rounded-lg border-[#b5b5b5] ">
                  <p>
                    Enter the link that directs users what you are promoting.
                  </p>
                </TooltipContent> */}
              </Tooltip>
            </TooltipProvider>
      ...
      <div className="flex gap-3 items-center">
        <Button type="button" size="lg" onClick={handleSendClick} disabled={isPending}>
          {isPending ? (
