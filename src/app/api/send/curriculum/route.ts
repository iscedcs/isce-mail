...
import { sendBulkEmailTracked } from "@/lib/mail-action/curriculum/mail";
...
import type { IBasis } from "@/lib/mail-action/curriculum/mail";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const result = await sendBulkEmailTracked(recipients, body.subject, body.basis as IBasis, body.message, body.courseName, body.link, body.pdfUrl, body.bannerImage);
